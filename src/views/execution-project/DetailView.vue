...
const ganttStatusColors = { 未开始: 'default', 启动逾期: 'orange', 进行中: 'processing', 即将到期: 'gold', 已完成: 'green', 已逾期: 'red', 逾期完成: 'volcano', 里程碑: 'green' }
const ganttStatusClasses = { 未开始: 'gantt-not-started', 启动逾期: 'gantt-overdue', 进行中: 'gantt-in-progress', 即将到期: 'gantt-due-soon', 已完成: 'gantt-completed', 已逾期: 'gantt-overdue', 逾期完成: 'gantt-overdue', 里程碑: 'gantt-milestone' }
